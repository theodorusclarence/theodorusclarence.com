...
<Image
  ...
  layout='responsive'
  src='/images/blogs/btb-flexbox-grid/1.png'
...
<Image
  className='bg-gray-500'
  layout='responsive'
  src='/images/blogs/btb-flexbox-grid/2.png'
  alt='Contoh bagi dua'
  width={1440}
  height={702}
/>
...
<Image
  className='bg-gray-500'
  layout='responsive'
  src='/images/blogs/btb-flexbox-grid/3.png'
  alt='Contoh item tengah'
  width={1440}
  height={50}
/>
...
<Image
  className='bg-gray-500'
  layout='responsive'
  src='/images/blogs/btb-flexbox-grid/4.png'
...
<Image
  className='bg-gray-500'
  layout='responsive'
  src='/images/blogs/btb-flexbox-grid/5.png'
  alt='Layout kanan kiri'
  width={1425}
  height={712}
/>
