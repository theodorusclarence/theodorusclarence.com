...
<figure className='mx-auto' style={{ maxWidth: 750 }}>
  <CloudinaryImg
...
<figure className='mx-auto' style={{ maxWidth: 401 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 405 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 536 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 719 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 415 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 315 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 715 }}>
  <CloudinaryImg
    className='bg-gray-500'
...
<figure className='mx-auto' style={{ maxWidth: 544 }}>
  <CloudinaryImg
    className='bg-gray-500'
