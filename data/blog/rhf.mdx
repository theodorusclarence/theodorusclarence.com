...
description: 'Building fo ms with validation is tedious and repetitive, using reusable component will help building faster.'
englishOnly: 'true'
---
...
> I'm open for all suggestions and contributions to improve 🚀. Open a PR on the repository (available on the demo website) or email me at theodorusclarence@gmail.com
...
### 1. [Text Input](https://rhf.clarence.link/inputs#text-input)
...
### 2. [PasswordInput](https://rhf.clarence.link/inputs#password-input)
...
### 5. [Select (Native)](https://rhf.clarence.link/inputs#select-native)
...
### 6. [File Upload Dropzone](https://rhf.clarence.link/inputs#dropzone-input)
...
### 7. [Select (react-select)](https://rhf.clarence.link/inputs#select-react)
