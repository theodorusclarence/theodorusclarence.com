        ...
        <section className='py-6 mt-4'>
          <article className='space-y-4 prose dark:prose-dark layout'>
            ...
            <p>
              ...
              loved frontline workers. The frontline workers can also see all of
            ...
            <p>
              This project was built using Next.js, Tailwindcss, SWR, and
              Firebase. Personally, I think using these stacks is a great choice
              due to the lack of time and for simplicity. We only use the
              firebase for the firestore because it is simple to configure.
              Next.js is also a great choice because we can mix and match the
              rendering type that we are using. For the dynamic content such as
              rendering the card's data from firestore, we use client-side
              rendering and utilizing SWR to cache the data.
            </p>
            ...
            <p>
              ...
              America. It's quite a challenge for me to fit in into their
              timezone so we can still work together. Also, there are only 36
              hours to finish a functioning full-stack application.
            </p>
            <figure className='w-full overflow-hidden rounded-sm shadow-md dark:shadow-none'>
              <CloudinaryImg
            ...
            <p>
              We incorporated a library to simulate flipping cards, but
              sometimes the user didn't open it while editing. So we decided to
              make a UX improvement by opening it when user starts filling out
              the form.
            </p>
            <img
              className='mx-auto'
            ...
            <p>
              During this project the largest problem is time management because
              we need to map out everything we need on the website, then develop
              it in just a short time. So during the creation of the
              application, we divide the project into little parts so it is
              still manageable.
            </p>
            <p>
              There is also a tricky part when I was building a like button. I
              need to get the latest data on the likes from the database, then
              increment it. Also, I need to make a condition where each person
              can only like once. In the end, it was successful by utilizing
              local storage to store the state.
            </p>
            ...
            <p>
              ...
              Before, it seems jarring to set up firebase and firestore
              connection. But turns out it was not that hard, also Next.js has a
              built-in API route so I can implement SWR caching without the use
              of another library.
            </p>
            <p>
              Because the rest of my team is American, I actually get to
              practice my English in this project. It was definitely harder
              explaining a code with another language 😁.
            </p>
