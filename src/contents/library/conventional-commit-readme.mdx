...
Commit message will be checked using [husky and commit lint](https://se.isfusion.cloud/library/husky-commitlint-prettier), you can't commit if not using the proper convention below.
...
Commit message akan dicek menggunakan [husky and commit lint](https://se.isfusion.cloud/library/husky-commitlint-prettier), jika convention salah, maka tidak bisa melakukan commit
