...
really _does_ play dead because it will indeed be left alone by predators who prefer their meat fresh. The bird weaves its next
_just so_ to reap the benefits for brooding and hatching eggs. The antelope stots to signal their fitness to the persuer: "Don't
...
We go from "hard-wired" to "higher-order" at some stage in our development, just as across species this sort of thing seems
to emerge. The capacity to abstractly apply our lessons to new scenarios, new materials and new topics is a uniquely human order.
...
to know _everything_ to function. While it wasn't the intention of Dennett to necessarily inspire, the specific passages had such
an effect on me. It is quite a wonderful thing to comprehend.
