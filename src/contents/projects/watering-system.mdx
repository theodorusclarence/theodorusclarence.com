...
> set target moisture levels -> read actual moisture levels -> if actual level is below target level -> open valve -> turn on pump for a certain run time -> turn off pump -> close valve -> read actual moisture levels -> (begin process again)...
...
## Microntroller and moisture sensor set up
...
<Img
  mdx
  publicId='/images/projects/water-system/water-resevoir-top.jpg'
  alt='water resevoir top'
  width={600}
  height={650}
...
<Img
  mdx
  publicId='/images/projects/water-system/water-resevoir-inside-1.jpg'
  alt='water resevoir lid bottom'
  width={600}
  height={650}
  aspect={{ width: 1, height: 1 }}
/>
<Img
  mdx
  publicId='/images/projects/water-system/water-resevoir-inside-2.jpg'
  alt='water resevoir inside'
  width={600}
  height={650}
  aspect={{ width: 1, height: 1 }}
/>
