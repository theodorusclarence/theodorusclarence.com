...
SDA to GPIO 32 and GPIO 33 respectively. After that you just need a line for 3.3V and GND and one connected to GPIO 34 for an INT signal to wakeup the board.
