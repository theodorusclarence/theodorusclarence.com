...
and comment out [these lines](https://github.com/emackinnon1/lilygo-bump-GPS/blob/main/lilygo_bump_GPS.ino#L43-L44) in order to try out making http requests. You can comment out the other
...
SDA to GPIO XX and GPIO XX respectively. After that you just need a line for 3.3V and GND and one connected to GPIO XX for an INT signal to wakeup the board.
