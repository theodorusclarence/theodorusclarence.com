...
This is how tattooing happened. I drew my first couple of them and had someone else do them on me. Then, I discovered stick and poke
and went to town. Then I graduated to a machine once I get tired of the lengthiness of process that stick and poke tattoos require.
...
<Carousel
  slides={{
    '/images/blog/tattoos/snake-drawing.jpg':
      'colored pencil drawing of snake tattoo',
    '/images/blog/tattoos/helmet-skull-drawing.jpg.jpg':
      'Drawing of a melting helmet',
  }}
  height={700}
  width={850}
  noStyle={true}
