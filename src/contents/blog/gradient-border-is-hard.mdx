...
I thought to myself, that would be simple enough to make: a button, with a transparent and blur background, and add in a gray-ish gradient border around it. Probably something like `border: linear-gradient()` would definitely work.
...
<CloudinaryImg
  mdx
  publicId='theodorusclarence/blogs/gradient-border-is-hard/gradient-gif'
  alt='GIF about get started'
  width={800}
  height={320}
/>
