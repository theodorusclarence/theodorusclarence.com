...
When I was a kid, I used to draw _all_ the time; I had a sketchbook with me pretty much everywhere I went. I took some art classes
and learned a thing or two about composition. There are some general rules that make or break good compositions: the rule of
thirds, foreground and background focusing, framing, so on and so forth.
...
It means you can reliably iterate and improvement has a direction. It means there is a transcendent "language" to art and less
subjective than the pop culture arguments might
